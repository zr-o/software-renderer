...
namespace math
{
    ...
    struct Vector
    {
        ...
        [[nodiscard]] inline constexpr T x() const { return elements[0]; }
        [[nodiscard]] inline constexpr T y() const requires(Dimension > 1) { return elements[1]; }
        [[nodiscard]] inline constexpr T z() const requires(Dimension > 2) { return elements[2]; }
    ...
    [[nodiscard]] constexpr Vector<T, 3> crossProduct(const Vector<T, 3> &v1, const Vector<T, 3> &v2)
    {
